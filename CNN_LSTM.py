...
scaler=StandardScaler()all_data_train=np.concatenate((x_train, x_test), axis= 0)
...
'''model.add(layers.TimeDistributed(layers.Conv2D(32, (2, 2), activation='relu', input_shape=input_shape)))
